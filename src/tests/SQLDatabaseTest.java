...
public class SQLDatabaseTest {
    ...
    public void testTablesDiffs() {
        ...
        assertEquals(
                "The expected tables to update should be 1 because only one table they have in common is different", 1,
                tablesToUpdate.size());
    ...
    public void testFirstSteps() {
        ...
        assertEquals("First steps should contain the second sql statment added", true,
                db.getFirstSteps().contains(first2));
        liveTables.put(table2.getName(), table2);
        db.compareTables(liveTables);
