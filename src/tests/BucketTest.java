...
public class BucketTest {
    ...
    private String bucketName, name, create, drop;
    ...
    public void testCompareSimple() {
        ...
        assertEquals("The statements needed to make two buckets with a total of 1 document and 0 indices is 1 (create)",
                1, statements.size());
        assertEquals(
        ...
        assertEquals("The statements needed to make two buckets with a total of 1 document and 0 indices is 1 (drop)",
                1, statements.size());
        assertEquals(
