...
public class SQLiteTableTest {
    ...
    public void testAddColumn() {
        ...
        table1 = new SQLiteTable(name, create);
        assertEquals(
                "The size of the column list for the table should be 2 when two colmns have been added to the column list",
    ...
    public void testAddIndex() {
        ...
        table1 = new SQLiteTable(name, create);
        assertEquals(
                "The size of the index list for the table should be 2 when two indices have been added to the column list",
    ...
    public void testRecreateTable() {
        ...
        sql = table2.equals(table1);
        assertEquals(
                "The sql generated should recreate the table to be like the dev one when modifying several columns",
                expectedSQL, sql);
        // add a primary key
        // setup tables
        name = "blooper";
    ...
    public void testRecreateTableSpecial() {
        ...
        sql = table2.equals(table1);
        assertEquals(
                "The sql generated should recreate the table to be like the dev"
